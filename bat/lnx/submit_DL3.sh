...
python3 $HOME/LeleNet/py3/LeleNet_trn.py "dl3" 8 300 -esp 40 -dd $TMP -ww 0.20 -op "adam" -lr 1e-4 -lrd 0.995 -out "D512" -tbn "D512"
echo "512 px run finished"
rm -r $TMP/dat/tls/03_2021
cp -r $HOME/LeleNet/dat/tls/BX_256_21 $TMP/dat/tls/03_2021
python3 $HOME/LeleNet/py3/LeleNet_trn.py "dl3" 16 300 -esp 40 -dd $TMP -ww 0.20 -op "adam" -lr 1e-4 -lrd 0.995 -out "D256" -tbn "D256"
