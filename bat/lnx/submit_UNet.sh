...
python3 $HOME/LeleNet/py3/LeleNet_trn.py "unet" 4 300 -esp 40 -dd $TMP -ww 0.10 -op "adam" -lr 1e-4 -lrd 1.0 -out "U1024" -tbn "U1024"
echo "1024 px run finished"
rm -r $TMP/dat/tls/03_2021
cp -r $HOME/LeleNet/dat/tls/BX_512_21 $TMP/dat/tls/03_2021
python3 $HOME/LeleNet/py3/LeleNet_trn.py "unet" 8 300 -esp 40 -dd $TMP -ww 0.10 -op "adam" -lr 1e-4 -lrd 1.0 -out "U512" -tbn "U512"
echo "512 px run finished"
rm -r $TMP/dat/tls/03_2021
cp -r $HOME/LeleNet/dat/tls/BX_256_21 $TMP/dat/tls/03_2021
python3 $HOME/LeleNet/py3/LeleNet_trn.py "unet" 16 300 -esp 40 -dd $TMP -ww 0.10 -op "adam" -lr 1e-4 -lrd 1.0 -out "U256" -tbn "U256"
