...
print(xtable(df_all_spec,
             caption = "List of all tree species found in the research plots. Taxon names and information were semiautomatically matched and updated following World Flora Online (Kindt, 2021; WFO, 2022). Subsequently, information were manually checked.",
      ...
      add.to.row = list(list(nrow(df_all_spec)),  
                        '\\bottomrule\n\\multicolumn{5}{l}{Kindt, Roeland (2020). \“WorldFlora: An R Package for Exact and Fuzzy Matching of Plant Names against
the World Flora Online Taxonomic Backbone Data\”. In: openitshapeApplications in Plant Sciencescloseitshape 8. 9, e11388. issn: 2168-0450. doi: \\href\\{10.1002/aps3.11388\\}\\{\\}.\nWFO (2022): World Flora Online. Published on the Internet; \\url{http://www.worldfloraonline.org}. Accessed on: 06 Feb 2022}\\\\'))
# adjust table size
